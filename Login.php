							...
							<div class="card-body text-left" style="width:95%">
								...
								<form method="post">
									...
									<div class="md-form">
										...
										<input type="text" id="defaultForm-email" name="txt_uname_email" class="form-control" mdbActive style="margin-left:25px" required>
										<label for="defaultForm-email">Your email</label>
									</div>

									<div class="md-form">
										<i class="fa fa-lock prefix grey-text"></i>
										<input type="password" id="defaultForm-pass" name="txt_password" class="form-control" mdbActive style="margin-left:25px" required>
										<label for="defaultForm-pass">Your password</label>
									</div>

									<div class="text-center">
										<button name="btn-login" class="btn btn-default waves-light" mdbRippleRadius>Login</button>
									</div>
