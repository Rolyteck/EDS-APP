...
try {
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST"){
		...
		if (isset($_POST['login'])){
			...
			$stmt->execute([$email]);
					//retrieves data form database instead of using fetch_obj
		...
		if (isset($_POST['login'])){
				...
				//$valid checks if password_verify matches former hashed password in database
